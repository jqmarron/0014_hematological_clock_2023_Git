...
STRATEGY: Use the DNN 10FCV process including to determine feature importance as per Gedeon's  approach explained in DATA MINING OF INPUTS: ANALYSING MAGNITUDE AND FUNCTIONAL MEASURES Gedeon 1 DOI: 10.1142/s0129065797000227
-Use the entire dataset( This process is independent of the clock construction)
-Perform 10FCV using stratified samples for stratified importance.
