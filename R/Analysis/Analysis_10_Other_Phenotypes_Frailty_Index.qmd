...
Strategy: Find maximun in the acceleration curve and split the regression into two. Acceleration up to the maximum and the acceleration after the maximum (less number of observations with FI). Two regressions, four estimates
Find the maximum fitting a lm that minimizes the residual std error (scaled Acceleration)
...
31 points in where to break FI; Lets remove 3 point on each tail
